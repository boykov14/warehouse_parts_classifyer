...
#
# from warehouse_parts_classifyer.parameters.default_values import ESOLUTION, RESTORE_PATHS
...
#             box = change_fov(box)
#             img_dims = img.shape
#             cv2.imshow('a', draw_boxes(img[:,:,0] / 255, box[:, :4] * RESOLUTION[0], box[:, 4], class_names))
#             cv2.imshow('b', img[:,:,1])
#             cv2.waitKey(60)
#         else:
#             cv2.imshow('a', img[:,:,0])
