...
class Gesture_Localizer():
    ...
    def create_first_stage(self, anchors = YOLO_ANCHORS):
        ...
        # Create model body.
        yolo_model = yolo_body(image_input, len(anchors), self.n_classes, self.batch_size, 0, stateful = True)
    ...
    def extract_data(self, filepath):
        ...
        training_generator = DataGenerator(data_out[:1 - n_test_files], num_files - n_test_files, num_imgs[:1 - n_test_files],  YOLO_ANCHORS, 0, self.batch_size, sequence_length=10, shuffle=True)
